...
class SingleMask(_message.Message):
    __slots__ = ("vertices", "color", "area", "totalCounts", "totalGenes", "cellId", "clusterId", "proteins", "umapValues")
    ...
    def __init__(self, vertices: _Optional[_Iterable[float]] = ..., color: _Optional[_Iterable[int]] = ..., area: _Optional[str] = ..., totalCounts: _Optional[str] = ..., totalGenes: _Optional[str] = ..., cellId: _Optional[str] = ..., clusterId: _Optional[str] = ..., proteins: _Optional[_Mapping[str, float]] = ..., umapValues: _Optional[_Union[UmapEntry, _Mapping]] = ...) -> None: ...
