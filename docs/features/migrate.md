...
Brings older G4X outputs up to the latest schema used by G4X-viewer and G4X-helpers. The command renames or relocates legacy files, regenerates viewer artifacts when needed, and creates a backup before applying changes.
